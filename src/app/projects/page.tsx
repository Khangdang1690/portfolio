...
const projects = [
  {
    title: "Foicedetect",
    description: "Deepfake voice detection model using SVM classifier on 100+ audio samples with 94% accuracy.",
    technologies: ["NumPy", "Scikit-learn", "Librosa", "Django"],
    achievements: "Nosu AI Hackathon Winner - $325",
    link: "https://devpost.com/software/foicedetect/",
    github: "https://github.com/dahomita/foicedetect",
    details: [
      "Built deepfake voice detection model using SVM classifier on 100+ audio samples, achieving 94% accuracy.",
      "Integrated AssemblyAI and Nebius APIs to automate 90% of voice analysis, cutting verification time by 95%.",
      "Enabled real-time voice detection to present to 150+ AI professionals at USF ACM AI Convention."
    ]
  },
  {
    title: "SafeGuard",
    description: "Real-time fall detection algorithm with virtual emotional support bot for elderly care.",
    technologies: ["Docker", "Azure", "React", "Node.js", "Flask"],
    achievements: "Google HackUSF Winner - $200",
    link: "https://devpost.com/software/safeguard-oq572w",
    github: null,
    details: [
      "Won Moffitt AI in Healthcare track by building a real-time fall detection algorithm with 57% accuracy, and integrated a virtual emotional support bot using Deepgram API and WebSockets to enhance elderly care.",
